...
class OpenAIClient
{
    ...
    {
        $system = "You are a strict lead-qualification assistant for marketing websites. Classify emails as 'genuine', 'spam', or 'unknown'. Provide a score 0–100 and a concise explanation. Be conservative; only mark 'genuine' when it's clearly a real inquiry.";
